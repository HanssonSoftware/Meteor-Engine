...
static constexpr int MR_DEFAULT_DELEGATE_SIZE = 512;
static constexpr int MR_GIGANTIC_DELEGATE_SIZE = 4096;
...
#define CREATE_DELEGATE(Name, ...) \
    inline Delegate<void, MR_DEFAULT_DELEGATE_SIZE, __VA_ARGS__> Name

#define CREATE_DELEGATE_RETVAL(RetVal, Name, ...) \
    inline Delegate<RetVal, MR_DEFAULT_DELEGATE_SIZE, __VA_ARGS__> Name

#define CREATE_GIGANTIC_DELEGATE(Name, ...) \
    inline Delegate<void, MR_GIGANTIC_DELEGATE_SIZE, __VA_ARGS__> Name